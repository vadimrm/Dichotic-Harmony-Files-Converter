...
// читает кусок файла по текущему смещению, возвр€щает число прочитанных байт
{
...
// пропущенные при этом куски заполн€ютс€ нул€ми (если смещение больше длины файла)
{
...
// создает файл с нул€, а если он есть - записывает в файл методом добавлени€ к концу
{
...
// в read-функци€х сначала идет младший байт, затем старший (Intel CPU order)
